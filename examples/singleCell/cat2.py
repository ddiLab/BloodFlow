...
renderView1.ViewSize = [1357, 755]
renderView1.AxesGrid = 'GridAxes3DActor'
renderView1.CenterOfRotation = [9.5, 9.5, 19.5]
renderView1.StereoType = 'Crystal Eyes'
renderView1.CameraPosition = [61.69571518316547, 15.338186393274212, 94.416706131091]
renderView1.CameraFocalPoint = [9.5, 9.5, 19.5]
renderView1.CameraViewUp = [-0.08871750741690776, 0.9959314895285298, -0.015801013993249007]
...
fluidpvd = PVDReader(registrationName='fluid', FileName='C:\\Users\\antho\\OneDrive\\Desktop\\College\\sen\\fluid.pvd')
...
velocityLUT.RGBPoints = [0.0, 0.231373, 0.298039, 0.752941, 9.822746297754323e-06, 0.865003, 0.865003, 0.865003, 1.9645492595508646e-05, 0.705882, 0.0156863, 0.14902]
velocityLUT.ScalarRangeInitialized = 1.0

# get opacity transfer function/opacity map for 'velocity'
velocityPWF = GetOpacityTransferFunction('velocity')
velocityPWF.Points = [0.0, 0.0, 0.5, 0.0, 1.9645492595508646e-05, 1.0, 0.5, 0.0]
velocityPWF.ScalarRangeInitialized = 1

# trace defaults for the display properties.
fluidpvdDisplay.Representation = 'Point Gaussian'
...
fluidpvdDisplay.ScalarOpacityUnitDistance = 0.8567029949045565
...
fluidpvdDisplay.ScaleTransferFunction.Points = [-2.071810278890647e-07, 0.0, 0.5, 0.0, 2.0718102788906455e-07, 1.0, 0.5, 0.0]

# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
fluidpvdDisplay.OpacityTransferFunction.Points = [-2.071810278890647e-07, 0.0, 0.5, 0.0, 2.0718102788906455e-07, 1.0, 0.5, 0.0]
